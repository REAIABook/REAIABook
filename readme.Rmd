...
Also you should allocate a directory for the data that will be downloaded in the code that has at least 2 GB of open space.  This should be used as the data directory (**data.dir**) in the code. 
